...

{
  ...
  home.file.".local/share/icons/hicolor/16x16/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/16x16/apps/firefox.png";
  home.file.".local/share/icons/hicolor/24x24/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/24x24/apps/firefox.png";
  home.file.".local/share/icons/hicolor/32x32/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/32x32/apps/firefox.png";
  home.file.".local/share/icons/hicolor/48x48/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/48x48/apps/firefox.png";
  home.file.".local/share/icons/hicolor/64x64/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/64x64/apps/firefox.png";
  home.file.".local/share/icons/hicolor/128x128/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/128x128/apps/firefox.png";
  home.file.".local/share/icons/hicolor/256x256/apps/firefox.png".source = "${pkgs.firefox}/share/icons/hicolor/256x256/apps/firefox.png";
